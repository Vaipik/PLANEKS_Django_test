...
urlpatterns = [
    path("edit_schema/<slug:schema_url>", views.EditUserSchema.as_view(), name="edit_user_schema"),
    path("delete_schema/<slug:schema_url>", views.delete_user_schema, name="delete_user_schema"),
    ...
    path("delete_dataset/<uuid:dataset_id>", views.delete_dataset_file, name="delete_dataset"),
