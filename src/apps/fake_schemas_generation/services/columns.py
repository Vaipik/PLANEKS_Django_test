...
def get_updated_formset(*, form_data: dict, formset: ColumnFormSet, button_data: str,
                        instance: Optional[Schema] = None) -> ColumnFormSet:
    """
...
def _add_new_column(form_data: dict, formset: ColumnFormSet, instance: Optional[Schema]) -> ColumnFormSet:
    """Adding new form in column formset"""
    column_formset = formset(form_data, instance=instance) if instance else formset(form_data)
...
def _delete_column(form_data: dict, formset: ColumnFormSet, button_data: str,
                   instance: Optional[Schema]) -> ColumnFormSet:
    """
